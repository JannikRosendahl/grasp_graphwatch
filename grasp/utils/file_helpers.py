...
def generate_experiment_file_prefix(
    base_name: str, params: dict[str, str]
) -> str:
...
def generate_storage_paths(
    ...
    paths: dict[str, Path] = {
        "graph_storage": base
        / "graph_storage"
        / f"{experiment_prefix}_graph_storage.pt",
        ...
        "location_autoencoder": base
        / "models"
        / f"{experiment_prefix}_location_autoencoder.pt",
        "classification_model": base
        / "models"
        / f"{experiment_prefix}_classification_model.pt",
        "cluster_manager": base
        / "models"
        / f"{experiment_prefix}_cluster_manager.pt",
        ...
        "detailed_report": base
        / "reports"
        / f"{experiment_prefix}_detailed_report.json",
        "visualizations_dir": base
        / "reports"
        / "visualizations"
        / experiment_prefix,
    }
